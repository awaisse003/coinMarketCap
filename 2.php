...
<title>Cryptocurrency Market Capitalizations - Page 2 of 17 | CoinMarketCap</title>
...
<li><a href="index.php">Coins Only</a></li>
...
Top Cryptocurrencies by Market Capitalization (Page 2)
</h1>
</div>
</div>
</div>
...
<li><a href="index.php">&larr; Previous 100</a></li>
<li><a href="3.php">Next 100 &rarr;</a></li>
<li>
...
$json_url = "https://api.coinmarketcap.com/v2/ticker/?start=101&limit=100&structure=array";
$json = file_get_contents($json_url);
$data = json_decode($json, TRUE);
