...
<title>Cryptocurrency Market Capitalizations - Page 6 of 17 | CoinMarketCap</title>
...
Top Cryptocurrencies by Market Capitalization (Page 6)
</h1>
</div>
</div>
</div>
...
<li><a href="5.php">&larr; Previous 100</a></li>
<li><a href="7.php">Next 100 &rarr;</a></li>
<li>
...
$json_url = "https://api.coinmarketcap.com/v2/ticker/?start=501&limit=100&structure=array";
$json = file_get_contents($json_url);
$data = json_decode($json, TRUE);
