...
<title>Cryptocurrency Market Capitalizations - Page 17 of 17 | CoinMarketCap</title>
...
Top Cryptocurrencies by Market Capitalization (Last)
</h1>
</div>
</div>
</div>
...
<li><a href="16.php">&larr; Previous 100</a></li>
...
$json_url = "https://api.coinmarketcap.com/v2/ticker/?start=1601&limit=".$total_active."&structure=array";
$json = file_get_contents($json_url);
$data = json_decode($json, TRUE);
