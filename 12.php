...
<title>Cryptocurrency Market Capitalizations - Page 12 of 17 | CoinMarketCap</title>
...
Top Cryptocurrencies by Market Capitalization (Page 12)
</h1>
</div>
</div>
</div>
...
<li><a href="11.php">&larr; Previous 100</a></li>
<li><a href="13.php">Next 100 &rarr;</a></li>
<li>
...
$json_url = "https://api.coinmarketcap.com/v2/ticker/?start=1101&limit=100&structure=array";
$json = file_get_contents($json_url);
$data = json_decode($json, TRUE);
